...
import { Article, FieldType, FIELD_CATEGORIES, FIELD_INFO } from '../types'
...
export default function CreateArticlePage({ field, onSave, onCancel }: CreateArticlePageProps) {
  const [formData, setFormData] = useState({
    title: '',
    excerpt: '',
    content: '',
    author: '',
    category: FIELD_CATEGORIES[field][0] || 'General',
    readTime: 5,
  })
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl shadow-clean p-8">
          ...
          <div className="flex items-center gap-4 mb-8 pb-8 border-b border-slate-200">
            ...
            <div>
              <h1 className="text-3xl font-black text-slate-900">Write in {fieldInfo.label}</h1>
              <p className="text-slate-600">{fieldInfo.description}</p>
            </div>
          </div>
